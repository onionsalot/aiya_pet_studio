    ...
    <div>
      ...
      <div className="flex justify-center px-5">
        <form ref={formRef} onSubmit={handleSubmit} className="w-full max-w-lg">
          ...
          <label className="form-label">
            Address Line 1
            <input className="form-input" type="text" name="address1" placeholder="Street Number and Name" required />
          </label>
          <label className="form-label">
            Address Line 2
            <input className="form-input" type="text" name="address2" placeholder="Apt/Suite/Unit" />
          </label>
          ...
          <label className="form-label">
            Confirm Email
            <input className="form-input" type="email" name="email_confirm" placeholder="Confirm Email" required />
          </label>
          <label className="form-label">
            Password
            <input className="form-input" type="password" name="password" placeholder="Password must be at least 6 characters long" minlength="6" required />
          </label>
          <label className="form-label">
            Confirm Password
